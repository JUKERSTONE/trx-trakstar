...
export const TrakstarPrivacyPolicyPage = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to TRAKSTAR, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TRAKSTAR.
          </p>
        </li>
        <li>
          <p>
